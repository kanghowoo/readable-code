...
import cleancode.minesweeper.tobe.minesweeper.exception.GameExceptioin;
...
public class ConsoleOutputHandler implements OutputHandler {
    ...
    public void showBoard(GameBoard board) {
        ...
        for (int row = 0; row < board.getRowSize(); row++) {
            ...
            for (int col = 0; col < board.getColSize(); col++) {
                ...
                //String cellSign = cellSignFinder.findCellSignFrom(cellPosition);
    ...
    @Override
    public void showExceptionMessage(GameExceptioin e) {
